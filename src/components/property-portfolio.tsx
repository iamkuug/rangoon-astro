    ...
    <div className="property-portfolio-page">
      ...
      <section className="relative w-4/5 mx-auto h-auto px-4">
        <Container className="py-24 relative">
          ...
          <div className=" relative flex flex-col gap-y-32 items-start">
      ...
      <section className="relative flex items-center justify-center py-12 md:py-10 px-4 md:px-5 min-h-[200px] md:min-h-[320px]">
        <img
        ...
        <div className="w-full md:w-4/5 mx-auto flex flex-col items-center md:items-start gap-6 md:gap-4">
          <h1 className="text-3xl font-sans md:text-5xl text-white text-center md:text-left">
            Ready to Invest?
          </h1>
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="font-semibold bg-white  rounded-full px-6 py-2 md:px-4 md:py-1 hover:ring hover:ring-white transition-all ease-in-out flex items-center justify-center active:bg-brand-secondary/80"
          >
            Invest with Us
          </a>
        </div>
      </section>
      <section className="flex flex-col items-center gap-16 py-12">
        <div className="border-b-2 py-10 border-brand-primary/50 w-2/5 flex items-center justify-center">
          <h1 className="text-brand-primary text-4xl font-sans font-light text-center">
            100% Focused on Excellence
          </h1>
        </div>
        <h1 className="text-4xl font-sans text-gray-500">Our Partners</h1>
        <div>
